            ...
            >
              ...
              <div className='relative rounded-lg overflow-hidden'>
                ...
                <div className='text-sm flex items-center justify-between p-2 bg-black/70 w-full absolute bottom-0 left-0'>
                  ...
                  <p className='text-gray-300'>{kConvertor(movie.vote_count)}</p>
                </div>
      ...
      {/* show Price Input */}
          ...
          <div className='mt-8'>
            ...
            <label  className='block text-sm font-medium mb-2'>Show Price</label>
              <div className='inline-flex items-center gap-2 border border-gray-600 px-3 py-2 rounded-md'>
                 ...
                 <input min={0} value={showPrice} className='outline-none' type="number"  onChange={(e)=>setShowPrice(e.target.value) } placeholder='Enter show Price'/>
          ...
          <div className='mt-6'>
            ...
            <label  className='block text-sm font-medium mb-2'>Select Date And Time</label>
              <div className='inline-flex items-center gap-5 border border-gray-600 pl-1 p-1 rounded-lg'>
