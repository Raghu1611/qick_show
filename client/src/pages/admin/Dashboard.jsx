...
const Dashboard = () => {
  ...
  {titel:"Total Bookings", value:dashboardData.totalBookings || "0",icon:ChartLineIcon},
  {titel:"Total Revenue", value:currency + dashboardData.totalRevenue || "0",icon:CircleDollarSignIcon},
  {titel:"Active shows", value:dashboardData.activeShows.length || "0",icon:PlayCircleIcon},
  {titel:"Total Users", value:dashboardData.totalUser || "0",icon:UserIcon},
  ]
  ...
  <div>
    <h1 className='text-sm'>{card.titel}</h1>
