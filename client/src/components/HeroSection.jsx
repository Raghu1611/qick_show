 ...
 <h1 className='text-5xl md:text-[70px] md:leading-18 font-semibold max-w-10'>Guardians <br/> of the Galaxy</h1>
      ...
      <div className='flex items-center gap-1'>
       ...
       <div className='flex items-center gap-1'>
        ...
        <p className='max-w-md text-gray-300'>Join a misfit team of heroes as they battle cosmic threats with humor, heart, and epic action. A thrilling Marvel adventure filled with unforgettable characters and stunning visuals.</p>
